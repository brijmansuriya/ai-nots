            ...
            <div className="flex min-h-screen flex-col items-center bg-background p-6 text-foreground lg:justify-center lg:p-8 dark:bg-background">
                    ...
                    <nav className="flex items-center justify-end gap-4">
                        {auth.user ? (
                            <Link
                                ...
                                className="inline-block rounded-sm border border-border px-5 py-1.5 text-sm leading-normal text-foreground hover:border-accent dark:border-border dark:text-foreground dark:hover:border-accent"
                            >
                                Dashboard
                            </Link>
                        ) : (
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-card p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_var(--border)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-card dark:text-foreground dark:shadow-[inset_0px_0px_0px_1px_var(--border)]">
                            ...
                            <ul className="mb-4 flex flex-col lg:mb-6">
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-border dark:before:border-border">
                                    <span className="relative bg-card py-1 dark:bg-card">
                                        <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-border bg-background shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-border dark:bg-background">
                                            <span className="h-1.5 w-1.5 rounded-full bg-muted dark:bg-muted" />
                                        </span>
                                    </span>
                                    <span>
                                        Read the
                                        <a
                                            ...
                                            target="_blank"
                                            className="ml-1 inline-flex items-center space-x-1 font-medium text-ai-coral underline underline-offset-4 dark:text-ai-coral"
                                        >
                                ...
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-0 before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-border dark:before:border-border">
                                    <span className="relative bg-card py-1 dark:bg-card">
                                        <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-border bg-background shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-border dark:bg-background">
                                            <span className="h-1.5 w-1.5 rounded-full bg-muted dark:bg-muted" />
                                        </span>
                            ...
                            <ul className="flex gap-3 text-sm leading-normal">
                                <li>
                                    <a
                                        ...
                                        target="_blank"
                                        className="inline-block rounded-sm border border-primary bg-primary px-5 py-1.5 text-sm leading-normal text-primary-foreground hover:border-primary hover:bg-primary/90 dark:border-border dark:bg-foreground dark:text-background dark:hover:border-accent dark:hover:bg-accent"
                                    >
                                        Deploy now
                                    </a>
                                </li>
                        ...
                        <div className="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-ai-light lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-ai-dark">
                            <svg
                                className="w-full max-w-none translate-y-0 text-ai-cyan opacity-100 transition-all duration-750 dark:text-ai-cyan starting:translate-y-6 starting:opacity-0"
                                viewBox="0 0 438 104"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
